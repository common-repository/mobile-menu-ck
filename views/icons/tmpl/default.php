...
<script src="<?php echo MOBILEMENUCK_MEDIA_URL ?>/assets/jquery.min.js" type="text/javascript"></script>
<script src="<?php echo MOBILEMENUCK_MEDIA_URL ?>/assets/jquery-noconflict.js" type="text/javascript"></script>
<link rel="stylesheet" href="<?php echo MOBILEMENUCK_MEDIA_URL ?>/assets/font-awesome.min.css" type="text/css" />
...
<div class="ckinterface">
	...
	<div style="position: relative; height: 46px; display: block;">
		<input type="text" tabindex="1" class="" id="filter-by" placeholder="<?php echo CKText::_('CK_SEARCH_ICONS') ?>" style="height:auto;margin:0;background-color: transparent; position: relative;">
	...
	<div>
		<h3><?php echo CKText::_('CK_FILTER_BY_GROUP') ?></h3>
		...
		<button class="ckbutton filter-category" id="filter-submit" onclick="filtericonsbycatck('accessibility')">Accessibility Icons</button>
		<button class="ckbutton filter-category" id="filter-submit" onclick="filtericonsbycatck('hand')">Hand Icons</button>

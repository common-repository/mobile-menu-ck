...
class CKInterfaceLight {
	...
	<div class="ckrow">
		<label></label>
		<span><img class="ckicon" src="<?php echo $this->imagespath ?>/offsetx.png" /></span><span><input type="text" id="<?php echo $prefix; ?>bgpositionx" name="<?php echo $prefix; ?>bgpositionx" class="<?php echo $prefix; ?> hasTip" style="width:30px;" title="<?php echo __('Background image position in the X axis (horizontal)', 'accordeon-menu-ck'); ?>" /></span>
	...
	<div class="ckrow">
		...
		<input type="text" id="<?php echo $prefix; ?>lineheight" name="<?php echo $prefix; ?>lineheight" class="<?php echo $prefix; ?> hasTip" style="width:30px;" title="<?php echo CKText::_('CK_LINEHEIGHT_DESC'); ?>" />
		<img class="ckicon" src="<?php echo $this->imagespath ?>/text_padding_left.png" />
		<input type="text" id="<?php echo $prefix; ?>textindent" name="<?php echo $prefix; ?>textindent" class="<?php echo $prefix; ?> hasTip" style="width:30px;" title="<?php echo CKText::_('CK_TEXTINDENT_DESC'); ?>" />
	</div>
	<?php
	}

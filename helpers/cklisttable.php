...
class CKListTable {
	...
	function ajax_user_can() {
		die( 'function CKListTable::ajax_user_can() must be over-ridden in a sub-class.' );
	}

	/**
	 * Prepares the list of items for displaying.
	 * @uses CKListTable::set_pagination_args()
	 *
	 * @since 3.1.0
	 * @access public
	 * @abstract
	...
	function prepare_items() {
		die( 'function CKListTable::prepare_items() must be over-ridden in a sub-class.' );
	}
	...
	function set_pagination_args( $args ) {
		...
		if ( ! headers_sent() && ( ! defined( 'DOING_AJAX' ) || ! DOING_AJAX ) && $args['total_pages'] > 0 && $this->get_pagenum() > $args['total_pages'] ) {
			MobilemenuckHelper::redirect( add_query_arg( 'paged', $args['total_pages'] ) );
			exit;
		}
...
<?php
	...
	function get_columns() {
		die( 'function CKListTable::get_columns() must be over-ridden in a sub-class.' );
	}

...
class CKListTableMenu extends CKListTable {
	...
	function get_data() {
		...
		$query = "SELECT * FROM " . $wpdb->prefix . "mobilemenuck_menus";
	...
	function column_default($item, $column_name) {
		switch ($column_name) {
			case 'name' :
				return '<a href="admin.php?page=mobilemenuck_edit_menu&id=' . $item->id . '">' . $item->name . '</a>';
			// case 'shortcode' :
				 // return '[mobilemenuck id=' . $item->id . ']';
			case 'state' :
				 return $item->state == 1 ? '<span class="cklabel cklabel-success">' . CKText::_('Enabled') . '</span>' : '<span class="cklabel">' . CKText::_('Disabled') . '</span>';
			default :
